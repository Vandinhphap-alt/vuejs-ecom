                            ...
                            <tbody>
                                <tr v-for="cart in carts" v-bind:key="cart.id">
                                    ...
                                    <td>
                                        ...
                                        <span class="min" v-on:click="decrementQty(cart.id)">-</span>
                                        <input type="tel" class="text-center inp" :value="cart.amount">
                                        <span class="max" v-on:click="incrementQty(cart.id)">+</span>
                                    </div>
                                    </td>
                                </tr>
                            </tbody>
